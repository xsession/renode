...
//
// PIC18 Timer2 — 8-bit timer with period register (PR2).
...
{
    public class PIC18_Timer2 : IBytePeripheral, IKnownSize
    {
        public PIC18_Timer2(IMachine machine, long frequency = 10_000_000)
        {
            IRQ = new GPIO();
        ...
        public byte ReadByte(long offset)
        {
            ...
            this.Log(LogLevel.Warning, "PIC18_Timer2: Read 0x{0:X}", offset);
            return 0;
        }
